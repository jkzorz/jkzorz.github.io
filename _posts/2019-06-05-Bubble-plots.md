...
Start by setting your directory, uploading a csv file with species as columns and samples as rows. 
...
Include examples with more OTUs, or colour your samples based on other parameters.... 
